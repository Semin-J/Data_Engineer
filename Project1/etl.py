...
def process_log_file(cur, filepath):
    ...
    time_data = [t.dt.values.tolist(),t.dt.hour.values.tolist(), t.dt.day.values.tolist(), t.dt.week.values.tolist(),\
    ...
    # load user table
    user_df = df[['userId', 'firstName', 'lastName', 'gender', 'level']].values
