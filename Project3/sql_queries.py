...
page varchar, registration bigint, sessionId int, song varchar, status int,
ts bigint, userAgent varchar, userId int);
""")

staging_songs_table_create = ("""
CREATE TABLE IF NOT EXISTS staging_songs
(id bigint identity(0, 1), num_songs int, artist_id varchar, artist_latitude numeric,
...
(songplay_id bigint identity(0, 1) PRIMARY KEY, start_time timestamp NOT NULL sortkey, user_id int NOT NULL,
level varchar NOT NULL, song_id varchar distkey, artist_id varchar, session_id int NOT NULL, location varchar, user_agent varchar,
...
(artist_id varchar PRIMARY KEY sortkey distkey, artist_name varchar NOT NULL, artist_location varchar, artist_latitude numeric, artist_longitude numeric);
""")
